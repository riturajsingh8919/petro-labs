...
export default function MechanicalCTA() {
  return (
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Verify your materials and components meet the highest
                    standards of strength, reliability, and safety with our
