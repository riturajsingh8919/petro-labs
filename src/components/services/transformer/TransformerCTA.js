...
export default function TransformerCTA() {
  return (
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Ensure the safety, reliability, and efficiency of your
                    transformers with our comprehensive oil testing services.
                  </p>

                  <div className="space-y-3 mb-8">
                    {[
                      "NABL-accredited laboratory",
                      "DGA interpretation included",
