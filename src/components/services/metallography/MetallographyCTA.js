...
export default function MetallographyCTA() {
  return (
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Ensure the reliability of your metals, welds, and coatings
                    with our advanced metallography testing services.
                  </p>

                  <div className="space-y-3 mb-8">
                    {[
                      "NABL-accredited laboratory",
                      "50x-1000x magnification capability",
                      "Expert metallurgical engineers",
                    ].map((feature, index) => (
                      <m.div
                        key={index}
                        initial={{ opacity: 0, x: -20 }}
