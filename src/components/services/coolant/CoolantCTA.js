...
export default function CoolantCTA() {
  return (
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Protect your engines from overheating, corrosion, and ensure
                    emission compliance with our expert testing services.
                  </p>

                  <div className="space-y-3 mb-8">
                    {[
                      "NABL-accredited laboratory",
                      "ISO 22241 certified DEF testing",
