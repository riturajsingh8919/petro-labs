...
export default function AirCTA() {
  return (
              ...
              <div>
                ...
                >
                  ...
                  <h2 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
                    Ensure Healthier{" "}
                    <span className="text-primary">Air Quality</span>
                  </h2>

                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Ensure regulatory compliance and safeguard community health
                    with our comprehensive air quality monitoring services.
                  </p>

                  <div className="space-y-3 mb-8">
                    {[
                      "NABL-accredited testing laboratory",
                      "CPCB, NAAQS, NIOSH, OSHA compliant",
