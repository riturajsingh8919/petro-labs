...
export default function RoHSCTA() {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                >
                  ...
                  <p className="text-white/80 text-lg mb-6 leading-relaxed">
                    Ensure your products meet RoHS & ELV compliance standards
                    for electronics and automotive exports to the EU.
                  </p>

                  <div className="space-y-3 mb-8">
                    {[
                      "EU RoHS & ELV compliant testing",
              ...
              <div className="space-y-4">
                ...
                <m.a
                  ...
                  whileHover={{ scale: 1.02, y: -4 }}
                  className="block bg-white/10 backdrop-blur-md rounded-2xl p-6 border-2 border-white/20 hover:border-secondary hover:bg-white/15 transition-all group cursor-pointer"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <HiArrowRight className="w-6 h-6 text-white/40 group-hover:text-secondary group-hover:translate-x-1 transition-all" />
                  </div>
                </m.a>
